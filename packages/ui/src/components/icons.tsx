  ...
  LogoSmall: (props: any) => (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M6.46,11.3L0,0h32s-16,28-16,28l-6.46-11.3,4.57-2.66,1.89,3.31,6.87-12.02h-13.73s1.89,3.31,1.89,3.31c0,0-4.57,2.66-4.57,2.66Z"
        clipRule="evenodd"
      />
    </svg>
  ),
  LogoIcon: (props: any) => (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M3.23,5.65L0,0h16s-8,14-8,14l-3.23-5.65,2.28-1.33.94,1.65,3.43-6.01h-6.87s.94,1.65.94,1.65c0,0-2.28,1.33-2.28,1.33Z"
        clipRule="evenodd"
      />
    </svg>
  ),
  Logo: (props: any) => (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M6.05,10.59L0,0h30s-15,26.25-15,26.25l-6.05-10.59,4.28-2.5,1.77,3.1,6.44-11.26h-12.87s1.77,3.1,1.77,3.1c0,0-4.28,2.5-4.28,2.5Z"
        clipRule="evenodd"
      />
      <path
        fill="currentColor"
        d="M36.98,5.4v3.52h2.41v1.97h-2.41v5.79c0,.52.12.91.36,1.16s.64.37,1.19.37c.32,0,.61-.03.86-.09v1.85c-.37.14-.86.21-1.48.21-.96,0-1.71-.28-2.27-.83s-.83-1.33-.83-2.34v-6.11h-2.13v-1.97h.6c.57,0,1-.16,1.29-.47.29-.32.43-.73.43-1.24v-1.81h1.99,0ZM42.85,10.25c1.07-1.12,2.43-1.68,4.09-1.68s3.01.56,4.09,1.68c1.07,1.12,1.61,2.53,1.61,4.22s-.53,3.13-1.6,4.25c-1.06,1.12-2.43,1.68-4.1,1.68s-3.03-.56-4.1-1.68c-1.06-1.12-1.6-2.53-1.6-4.25s.54-3.11,1.61-4.22ZM44.47,17.4c.67.7,1.49,1.05,2.47,1.05s1.79-.35,2.46-1.05c.67-.7,1.01-1.68,1.01-2.93s-.34-2.2-1.01-2.91c-.67-.7-1.49-1.05-2.46-1.05s-1.79.35-2.47,1.05-1.01,1.67-1.01,2.91.34,2.23,1.01,2.93ZM57.58,13.62v6.44h-2.18v-11.13h2.13v1.6c.74-1.28,1.88-1.92,3.43-1.92,1.28,0,2.26.41,2.95,1.23.69.82,1.03,1.88,1.03,3.17v7.06h-2.18v-6.69c0-1.87-.86-2.8-2.59-2.8-.82,0-1.45.29-1.91.87s-.68,1.31-.68,2.19v-.02ZM70.59,13.62v6.44h-2.18v-11.13h2.13v1.6c.74-1.28,1.88-1.92,3.43-1.92,1.28,0,2.26.41,2.95,1.23.69.82,1.03,1.88,1.03,3.17v7.06h-2.18v-6.69c0-1.87-.86-2.8-2.59-2.8-.82,0-1.45.29-1.91.87s-.68,1.31-.68,2.19v-.02ZM89.25,16.24l1.87.65c-.32,1.03-.93,1.88-1.8,2.54-.88.66-1.95.98-3.2.98-1.56,0-2.88-.54-3.97-1.61-1.09-1.07-1.63-2.52-1.63-4.34,0-1.7.52-3.1,1.57-4.21s2.3-1.67,3.75-1.67c1.68,0,2.99.53,3.93,1.59s1.41,2.47,1.41,4.25c0,.28-.02.51-.05.7h-8.38c.02.99.34,1.8.98,2.43.64.63,1.43.95,2.37.95,1.59,0,2.63-.75,3.12-2.24l.03-.02ZM82.83,13.34h6.09c-.03-.83-.31-1.52-.83-2.05-.52-.53-1.27-.8-2.22-.8-.86,0-1.57.28-2.13.84s-.86,1.23-.9,2h0ZM100.15,8.8v2.31c-.32-.05-.64-.07-.95-.07-2.04,0-3.05,1.14-3.05,3.43v5.58h-2.18v-11.13h2.13v1.94c.68-1.42,1.79-2.13,3.33-2.13.25,0,.49.02.72.07Z"
      />
    </svg>
  ),
  Overview: MdBarChart,
  ...
  TON: (props: any) => (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M10.1,15.3l-1.3-2.5L5.6,7.1c-0.2-0.4,0-0.8,0.5-0.8h4V15.3z M15.9,6.2h-4v9.1l1.3-2.5l3.2-5.7C16.6,6.7,16.3,6.2,15.9,6.2z   M22,11c0,6.1-4.9,11-11,11S0,17.1,0,11S4.9,0,11,0S22,4.9,22,11z M15.9,4.4L15.9,4.4H6.1c-1.8,0-2.9,1.9-2,3.5l6.1,10.5  c0.4,0.7,1.4,0.7,1.8,0L17.9,8C18.8,6.4,17.7,4.4,15.9,4.4z"
        clipRule="evenodd"
      />
    </svg>
  ),
  Telegram: (props: any) => (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M11,0C4.92,0,0,4.92,0,11s4.92,11,11,11,11-4.92,11-11S17.08,0,11,0ZM16.1,7.48c-.17,1.74-.88,5.96-1.25,7.91-.15.82-.46,1.1-.75,1.13-.64.06-1.12-.42-1.74-.83-.97-.63-1.52-1.03-2.45-1.65-1.09-.72-.38-1.11.24-1.75.16-.17,2.98-2.73,3.03-2.96,0-.03.01-.14-.05-.19-.06-.06-.16-.04-.23-.02-.1.02-1.64,1.04-4.64,3.07-.44.3-.84.45-1.19.44-.39,0-1.15-.22-1.71-.4-.69-.22-1.24-.34-1.19-.72.02-.2.3-.4.82-.61,3.21-1.4,5.35-2.32,6.41-2.76,3.05-1.27,3.69-1.49,4.1-1.5.09,0,.29.02.43.13.11.09.14.21.16.3s.03.28.02.43Z"
        clipRule="evenodd"
      />
    </svg>
  ),
