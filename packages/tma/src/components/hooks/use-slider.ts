...
import { clamp, isEqual } from "@/helpers";

import type { SliderProps } from "@/components/form/slider";
...
import { offsetXToScaledValue, toPercent } from "../utils/math";
