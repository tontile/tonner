...
export type UserOrganizations = Awaited<
  ReturnType<typeof getUserOrganizationsQuery>
>;
...
export type OrganizationUsers = Awaited<
  ReturnType<typeof getOrganizationUsersQuery>
>;
...
export async function getOrganizationUserQuery(
  ...
  let query = supabase
    ...
    .select(
      "*, user:users!user_id(*), organization:organizations!organization_id(*)",
    )
    .eq("user_id", user_id)
    .eq("organization_id", organization_id);
...
export type OrganizationUser = Awaited<
  ReturnType<typeof getOrganizationUserQuery>
>;
