export const accountKeys = {
  ...
  userAccounts: (user_id?: string) => ["user", user_id, "accounts"] as const,
};

export const invitationKeys = {
  organizationInvites: (organization_id?: string) =>
    ["organization", organization_id, "invitations"] as const,
  teamInvites: (team_id?: string) => ["team", team_id, "invitations"] as const,
  projectInvites: (project_id?: string) =>
    ["project", project_id, "invitations"] as const,
  userInvites: (user_id?: string) => ["user", user_id, "invitations"] as const,
};

export const navigationKeys = {
  list: (account_name?: string, partial_name?: string) =>
    ["account", account_name, partial_name, "navigations"] as const,
  navigation: (
    account_name?: string,
    partial_name?: string,
    nav_name?: string,
...
export const organizationKeys = {
  ...
  members: (organization_id?: string) =>
    ["organization", organization_id, "members"] as const,
  userOrganizations: (user_id?: string) =>
    ["user", user_id, "organizations"] as const,
...
export const projectKeys = {
  ...
  members: (project_id?: string) => ["project", project_id, "members"] as const,
  teams: (project_id?: string) => ["project", project_id, "teams"] as const,
  userProjects: (user_id?: string) => ["user", user_id, "projects"] as const,
  membership: (project_id?: string, user_id?: string) =>
    [...projectKeys.userProjects(user_id), project_id] as const,
  teamProjects: (team_id?: string) => ["team", team_id, "projects"] as const,
};

export const teamKeys = {
  list: () => ["teams"] as const,
  team: (team_id?: string) => ["team", team_id] as const,
  members: (team_id?: string) => ["team", team_id, "members"] as const,
  userTeams: (user_id?: string) => ["user", user_id, "teams"] as const,
